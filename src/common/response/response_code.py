...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_201 = (201, 'New request created successfully')
    HTTP_202 = (202, 'Request accepted, but processing not yet completed')
    HTTP_204 = (204, 'Request succeeded, but no content returned')
    HTTP_400 = (400, 'Bad request')
    HTTP_401 = (401, 'Unauthorized')
    HTTP_403 = (403, 'Forbidden')
    HTTP_404 = (404, 'Requested resource not found')
    HTTP_410 = (410, 'Requested resource has been permanently deleted')
    HTTP_422 = (422, 'Request parameters are invalid')
    HTTP_425 = (425, 'Request could not be processed due to server limitations')
    HTTP_429 = (429, 'Too many requests, server throttling')
...
class CustomResponse:
    """
    Provides open response status codes instead of enums, which can be useful if you want to customize response messages.
    """
...
class StandardResponseCode:
    ...
    HTTP_413 = 413  # REQUEST_ENTITY_TOO_LARGE: Payload Too Large
    HTTP_414 = 414  # REQUEST_URI_TOO_LONG: URI Too Long
    HTTP_415 = 415  # UNSUPPORTED_MEDIA_TYPE: Unsupported Media Type
    HTTP_416 = 416  # REQUESTED_RANGE_NOT_SATISFIABLE: Range Not Satisfiable
    HTTP_417 = 417  # EXPECTATION_FAILED: Expectation Failed
    HTTP_418 = 418  # UNUSED: I'm a teapot
    HTTP_421 = 421  # MISDIRECTED_REQUEST: Misdirected Request
    HTTP_422 = 422  # UNPROCESSABLE_ENTITY: Unprocessable Entity
    ...
    WS_1015 = 1015  # TLS_HANDSHAKE: TLS Handshake
